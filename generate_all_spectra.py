        ...
        if year and month and day:
            ...
            try:
                ...
                if use_synoptic_spec:
                    ovsp.plot(datetime(2024, 7, 31), figdir='/common/lwa/spec_v2/daily/', add_logo=add_logo,
...
if __name__ == "__main__":
    ...
    if args.oneday:
        ...
        yyyy_yesterday, mm_yesterday, dd_yesterday = yesterday.strftime("%Y"), yesterday.strftime(
            "%m"), yesterday.strftime("%d")

        one_day_proc(os.path.join(directory_path, yyyy_yesterday + mm_yesterday,
                                  'beam' + yyyy_yesterday + mm_yesterday + dd_yesterday), cal_dirs=pre_defined_cal_dir)
